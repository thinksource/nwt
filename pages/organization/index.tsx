...
export default function EnhancedTable(props: Props) {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Row>('status');
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none">
                        <Link href={`/organization/${row.id}`}><a>{row.name}</a></Link>
                      </TableCell>
                      <TableCell align="right">{row.website}</TableCell>
                      <TableCell align="right">{row.status}</TableCell>
                      <TableCell align="right">{row.mailext}</TableCell>
                      <TableCell align="right">{beMember(row.member)}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
