...
export class deletecontact1599635530543 implements MigrationInterface {
    name = 'deletecontact1599635530543'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `contact` DROP COLUMN `member`");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `contact` ADD `member` tinyint NOT NULL");
    }
