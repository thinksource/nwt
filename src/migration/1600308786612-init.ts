...
export class init1600308786612 implements MigrationInterface {
    name = 'init1600308786612'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `person` (`id` varchar(36) NOT NULL, `userId` varchar(255) NOT NULL, `title` enum ('Mr.', 'Miss', 'Dr.', 'Mrs.', 'Ms.', '') NOT NULL DEFAULT '', `first_name` varchar(255) NOT NULL DEFAULT '', `belongOrganizationId` varchar(255) NOT NULL, `last_name` varchar(255) NOT NULL, `expertise` text NOT NULL, `introduction` text NOT NULL DEFAULT '', `COVID_19` tinyint NOT NULL DEFAULT 0, UNIQUE INDEX `REL_83b775da14886d352de2a4cac0` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
