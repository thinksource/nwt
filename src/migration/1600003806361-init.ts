...
export class init1600003806361 implements MigrationInterface {
    name = 'init1600003806361'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `person` (`id` varchar(36) NOT NULL, `title` enum ('Mr.', 'Miss', 'Dr.', 'Mrs.', 'Ms.', '') NOT NULL DEFAULT '', `first_name` varchar(255) NOT NULL DEFAULT '', `belongOrganizationId` varchar(255) NOT NULL, `last_name` varchar(255) NOT NULL, `expertise` text NOT NULL, `introduction` text NOT NULL DEFAULT '', `COVID_19` tinyint NOT NULL DEFAULT 0, `userId` varchar(36) NULL, UNIQUE INDEX `REL_83b775da14886d352de2a4cac0` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `contact` (`id` varchar(36) NOT NULL, `title` enum ('Mr.', 'Miss', 'Dr.', 'Mrs.', 'Ms.', '') NOT NULL DEFAULT '', `personId` varchar(255) NOT NULL, `first_name` varchar(255) NOT NULL DEFAULT '', `last_name` varchar(255) NOT NULL, `job_title` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `country` varchar(255) NOT NULL, `state` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
