...
export class personnull1599620685938 implements MigrationInterface {
    name = 'personnull1599620685938'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `person` CHANGE `first_name` `first_name` varchar(255) NOT NULL DEFAULT ''");
        await queryRunner.query("ALTER TABLE `person` CHANGE `COVID_19` `COVID_19` tinyint NOT NULL DEFAULT 0");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `person` CHANGE `COVID_19` `COVID_19` tinyint NOT NULL");
        await queryRunner.query("ALTER TABLE `person` CHANGE `first_name` `first_name` varchar(255) NOT NULL");
