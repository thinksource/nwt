...
export class projectchange1599714142877 implements MigrationInterface {
    name = 'projectchange1599714142877'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `project` CHANGE `expertise_required` `brief` varchar(1000) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `project` CHANGE `brief` `expertise_required` varchar(1000) NOT NULL");
    }
