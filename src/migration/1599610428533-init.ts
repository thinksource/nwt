...
export class init1599610428533 implements MigrationInterface {
    name = 'init1599610428533'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `person` (`id` varchar(36) NOT NULL, `title` enum ('Mr.', 'Miss', 'Dr.', 'Mrs.', 'Ms.', '') NOT NULL DEFAULT '', `first_name` varchar(255) NOT NULL, `last_name` varchar(255) NOT NULL, `expertise` text NOT NULL, `COVID_19` tinyint NOT NULL, `userId` varchar(36) NULL, `belongOrganizationId` varchar(36) NULL, UNIQUE INDEX `REL_83b775da14886d352de2a4cac0` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `contact` (`id` varchar(36) NOT NULL, `job_title` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `member` tinyint NOT NULL, `country` varchar(255) NOT NULL, `state` varchar(255) NOT NULL, `personId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
