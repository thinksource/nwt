...
export class addcreatby1599710730740 implements MigrationInterface {
    name = 'addcreatby1599710730740'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `technology` ADD `creatbyId` varchar(36) NULL");
        await queryRunner.query("ALTER TABLE `project` ADD `creatbyId` varchar(36) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `project` DROP COLUMN `creatbyId`");
        await queryRunner.query("ALTER TABLE `technology` DROP COLUMN `creatbyId`");
    }
