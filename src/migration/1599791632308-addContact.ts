...
export class addContact1599791632308 implements MigrationInterface {
    name = 'addContact1599791632308'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `project` CHANGE `clinical_expertise` `expertise` text NOT NULL");
        await queryRunner.query("ALTER TABLE `contact` ADD `title` enum ('Mr.', 'Miss', 'Dr.', 'Mrs.', 'Ms.', '') NOT NULL DEFAULT ''");
        await queryRunner.query("ALTER TABLE `contact` ADD `first_name` varchar(255) NOT NULL DEFAULT ''");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `project` CHANGE `expertise` `clinical_expertise` text NOT NULL");
    }
